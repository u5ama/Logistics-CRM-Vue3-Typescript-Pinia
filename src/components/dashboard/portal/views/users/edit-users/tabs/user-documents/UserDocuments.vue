...
import { useUserDocumentsStore } from "@stores/users/documents";
...
const documentsStore = useUserDocumentsStore();
...
<template>
  <div class="wrapper max-w-6xl mt-6 mx-auto">
    ...
    <Panel>
      <template #header>
        <StyledHeading level="h3">User Documents</StyledHeading>
      </template>
