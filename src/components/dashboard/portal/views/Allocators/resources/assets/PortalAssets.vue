...
import AssetConfirmDeleteDialog from "./components/AssetConfirmDeleteDialog.vue";
    ...
    <PortalWidget class="widget">
      <div class="flex justify-between items-center mb-7">
        ...
        <div class="flex gap-x-2">
          <RouterLink :to="{ name: DashboardRouteNames.resourceNewAsset }">
            <Button
              icon="pi pi-plus"
              class="p-button-rounded p-button-success"
              v-tooltip.left="'Add New Asset'"
            />
          </RouterLink>
          <Button
            icon="pi pi-replay"
