...
import { addSubcontractorDocumentFormSchema } from "@utils/schemas";
...
const { handleSubmit, isSubmitting } = useForm({
  validationSchema: addSubcontractorDocumentFormSchema,
  validateOnMount: false,
});

const onSubmit = handleSubmit(
  async (values) => {
    const { title, reminder } = values;
      ...
      <div v-if="open" class="modal-mask">
        ...
        >
          ...
          >
            ...
            <DateInput name="reminder" label="Reminder Date" />
