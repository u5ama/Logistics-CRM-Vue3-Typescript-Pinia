...
import { addAssetDocumentFormSchema } from "@utils/schemas";
import Button from "primevue/button";
import StyledHeading from "@components/UI/typography/StyledHeading.vue";
import { useAssetDocumentsStore } from "@stores/resources/assetDocuments";
...
const documentsStore = useAssetDocumentsStore();
const { addDocument } = documentsStore;

const { handleSubmit, isSubmitting } = useForm({
  validationSchema: addAssetDocumentFormSchema,
    ...
    <Transition name="modal">
      <div v-if="open" class="modal-mask">
        ...
        >
          ...
          <StyledHeading class="mb-12"> Add Asset Document </StyledHeading>
