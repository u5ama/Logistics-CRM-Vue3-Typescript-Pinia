...
interface Props {
  attachments: IQuoteTermsConditions[];
  filters: DataTableFilterMeta;
}

interface Emits {
  (e: "edit", item: IQuoteTermsConditions): void;
  (e: "delete", item: IQuoteTermsConditions): void;
}
...
<template>
  <DataTable
    ...
    currentPageReportTemplate="Showing {first} to {last} of {totalRecords} terms&conditions"
