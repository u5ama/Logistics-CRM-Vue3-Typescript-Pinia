...
const { documents } = storeToRefs(quoteDocumentsStore);
const { getAllDocuments, deleteDocument } = quoteDocumentsStore;
...
<template>
  <div class="wrapper max-w-6xl mt-6 mx-auto">
    ...
    <Panel>
      <template #header>
        <StyledHeading level="h3">Quote Documents</StyledHeading>
      </template>
      <template #icons>
        <Button
          icon="pi pi-plus"
