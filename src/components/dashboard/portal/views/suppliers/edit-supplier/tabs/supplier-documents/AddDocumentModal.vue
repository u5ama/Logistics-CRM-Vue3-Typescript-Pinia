...
import { useSupplierDocumentsStore } from "@stores/suppliers/documents";
...
const documentsStore = useSupplierDocumentsStore();
...
const onSubmit = handleSubmit(
  async (values) => {
    const { title } = values;
    const success = await addDocument(supplierId, title, uploadedFile.value);
